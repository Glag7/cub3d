	...
	size_t w, size_t h)
{
	menu->textfields[SET_SENSI] = (t_textfield){.pos = (t_ulpoint){part(w,
			0.17), part(h, 0.39)}, .dim = (t_ulpoint){part(w, 0.12), part(h,
	...
	menu->textfields[SET_SPEEDMAX] = (t_textfield){.pos = (t_ulpoint){part(w,
			0.17), part(h, 0.52)}, .dim = (t_ulpoint){part(w, 0.12), part(h,
	...
	menu->textfields[SET_ACCEL] = (t_textfield){.pos = (t_ulpoint){part(w,
			0.17), part(h, 0.65)}, .dim = (t_ulpoint){part(w, 0.12), part(h,
	...
	menu->textfields[SET_ACCELDIFF] = (t_textfield){.pos = (t_ulpoint){part(w,
			0.17), part(h, 0.78)}, .dim = (t_ulpoint){part(w, 0.12), part(h,
	...
	menu->textfields[SET_SLOWER] = (t_textfield){.pos = (t_ulpoint){part(w,
			0.57), part(h, 0.13)}, .dim = (t_ulpoint){part(w, 0.12), part(h,
	...
	size_t h)
{
	menu->textfields[SET_FOV] = (t_textfield){.pos = (t_ulpoint){part(w, 0.17),
		part(h, 0.13)}, .dim = (t_ulpoint){part(w, 0.12), part(h, 0.06)},
	...
	menu->textfields[SET_VIEW] = (t_textfield){.pos = (t_ulpoint){part(w, 0.17),
		part(h, 0.26)}, .dim = (t_ulpoint){part(w, 0.12), part(h, 0.06)},
		.precision = 0, .v_min = MIN_VIEW, .v_max = MAX_VIEW,
		.dst = &set->view, .state = IDLE, .len = 0, .type = DOUBLE};
	menu->textfields[SET_TEXSIZ] = (t_textfield){.pos = (t_ulpoint){part(w,
			0.57), part(h, 0.26)}, .dim = (t_ulpoint){part(w, 0.12), part(h,
			0.06)}, .precision = 0, .v_min = MIN_TEXSIZ, .v_max = MAX_TEXSIZ,
		.dst = &set->saved_texsiz, .state = IDLE, .len = 0, .type = UINT};
	menu->textfields[SET_SKYSIZ] = (t_textfield){.pos = (t_ulpoint){part(w,
			0.57), part(h, 0.39)}, .dim = (t_ulpoint){part(w, 0.12), part(h,
			0.06)}, .precision = 0, .v_min = MIN_SKYSIZ, .v_max = MAX_SKYSIZ,
		.dst = &set->saved_skysiz, .state = IDLE, .len = 0, .type = UINT};
	menu->textfields[SET_WID] = (t_textfield){.pos = (t_ulpoint){part(w, 0.63),
		part(h, 0.78)}, .dim = (t_ulpoint){part(w, 0.12), part(h, 0.06)},
